...
__DEFINE__(1678263104297, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1678263104298,"./event-store":1678263104299}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1678263104298, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1678263104299, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1678263104298,"./utils":1678263104300}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1678263104300, function(require, module, exports) {
...
return __REQUIRE__(1678263104297);
})()
